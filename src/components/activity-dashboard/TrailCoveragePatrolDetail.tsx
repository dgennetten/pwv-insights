              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-stone-100 dark:border-stone-800 bg-stone-50/80 dark:bg-stone-950/50">
                    ...
                    <th className="text-right px-4 py-2.5 text-[10px] font-semibold uppercase tracking-wider text-stone-400 dark:text-stone-500">Contacted</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-stone-100 dark:divide-stone-800">
                  {sorted.map((row, i) => (
                    <tr key={`${row.date}-${i}`} className="hover:bg-stone-50 dark:hover:bg-stone-800/40 transition-colors">
                      ...
                      <td className="px-4 py-3 text-right font-semibold tabular-nums text-stone-700 dark:text-stone-300">{row.hikersContacted}</td>
                    </tr>
                  ))}
                </tbody>
              </table>

...
export const trailMetadata: Record<number, TrailMeta> = {
  ...
  210: { pdfUrl: BASE + 'Public_MedicineBowNorth.pdf',       lengthMiles: 5.1,  difficulty: 'moderate',  dogs: 'leash',    bikes: false, stock: 'allowed' },
  ...
  261: { pdfUrl: BASE + 'Public_RawahSouth.pdf',             lengthMiles: 3.3,  difficulty: 'moderate',  dogs: 'leash',    bikes: false, stock: 'allowed' },
